...
class ArticleController extends Controller
{
    ...
    {
        return view('articles.list',['articles'=>Article::orderBy('pub_date','desc')->paginate(4)]);
    }
    public function feeds(Feed $feed)
    {
        return view('articles.list',['articles'=>Article::where('feed_id',$feed->id)->orderBy('pub_date','desc')->paginate(4)]);
    }
